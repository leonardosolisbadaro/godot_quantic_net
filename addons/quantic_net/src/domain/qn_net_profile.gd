...
static func preset_high_frequency() -> RefCounted:
	return load("res://addons/quantic_net/src/domain/qn_net_profile.gd").new(60.0, 2.0, 100.0)

static func preset_standard() -> RefCounted:
	return load("res://addons/quantic_net/src/domain/qn_net_profile.gd").new(20.0, 1.0, 50.0)

static func preset_low_frequency() -> RefCounted:
	return load("res://addons/quantic_net/src/domain/qn_net_profile.gd").new(5.0, 0.5, 30.0)

static func preset_static() -> RefCounted:
	return load("res://addons/quantic_net/src/domain/qn_net_profile.gd").new(0.0, 0.0, 100.0)
